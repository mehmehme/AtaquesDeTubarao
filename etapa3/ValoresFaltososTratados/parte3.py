...
textuais = ['Name', 'Country', 'Area', 'Injury', 'Species']
...
def imputar_regressao_logistica(df, target):
    ...
    # se tem muitas classes únicas, usa moda simples
...
#bases com tratamento
df_num.to_csv('dados_numericos.csv', index=False)
df_cat.to_csv('dados_categoricos.csv', index=False)
df_txt.to_csv('dados_textuais.csv', index=False)

# Criando relatório final com valores válidos
